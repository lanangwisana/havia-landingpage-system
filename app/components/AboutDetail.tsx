...
const staticTeamMembers: TeamMember[] = [
  { id: 1, name: "Arief Budiman", role: "Principal Architect", image: "/havia-team-2.jpg", description: "Principle of Havia Studio team with over 15 years experience." },
  { id: 2, name: "Dina Rahmawati", role: "Senior Architect", image: "/havia-team-1.jpg", description: "Passionate about sustainable design and community spaces." },
  { id: 3, name: "Rizki Ramadhan", role: "Project Manager", image: "/havia-team-2.jpg", description: "Ensures every project runs smoothly on time and budget." },
  { id: 4, name: "Maya Sari", role: "Interior Designer", image: "/havia-team-1.jpg", description: "Creates warm and functional interior experiences." },
  { id: 5, name: "Budi Santoso", role: "Structural Engineer", image: "/havia-team-2.jpg", description: "Expert in earthquake-resistant structures." },
  { id: 6, name: "Siska Wijaya", role: "Architectural Designer", image: "/havia-team-1.jpg", description: "Brings innovative concepts into reality." },
  { id: 7, name: "Hendra Kusuma", role: "3D Visualizer", image: "/havia-team-2.jpg", description: "Creates stunning visualizations and walkthroughs." },
  { id: 8, name: "Rina Fitriani", role: "Landscape Architect", image: "/havia-team-1.jpg", description: "Designs harmonious outdoor spaces." },
];
